...
if __name__ == '__main__':
    ...
    dataset = SdcSimDataset('/home/eklavya/Downloads/beta_simulator_linux/data2/')
    dataloader = DataLoader(dataset, batch_size=30, shuffle=True, num_workers=4, collate_fn=collate_fn)
    net = NvidiaNet()
